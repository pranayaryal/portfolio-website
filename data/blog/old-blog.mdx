...
The following iterates over an array of numbers and returns a new
...
The following iterates over an array of numbers and filters the array
...
The interviewer might ask the difference between the three. Other
...
3. <HighlightBox>
   ...
   - Force a function to use an object at their `this` place. Here,
